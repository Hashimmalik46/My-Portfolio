      ...
      {isOpen && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-3 sm:p-5 md:p-6 overflow-hidden pointer-events-auto select-auto font-jakarta">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl h-[88dvh] sm:h-[660px] max-h-[92dvh] sm:max-h-[90vh] bg-[#0c0d12] border border-white/[0.14] rounded-2xl sm:rounded-3xl shadow-[0_30px_90px_rgba(0,0,0,0.95),inset_0_1px_1px_rgba(255,255,255,0.15)] flex flex-col z-10 overflow-hidden"
          >
            {/* 1. Header Bar */}
            <div className="shrink-0 flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-white/[0.08] bg-[#090a0f]/80 backdrop-blur-md gap-2">
              ...
              <button
                ...
                className="w-7 h-7 sm:w-8 sm:h-8 shrink-0 rounded-full bg-white/[0.06] hover:bg-white/[0.12] border border-white/10 flex items-center justify-center text-white/70 hover:text-white transition-colors cursor-pointer"
              >
                <X size={14} />
              </button>
            </div>
            ...
            {/* 3. Action Footer */}
            <div className="shrink-0 flex items-center justify-between gap-2.5 sm:gap-3 px-4 sm:px-6 py-3 sm:py-4 border-t border-white/[0.08] bg-[#090a0f]/80 backdrop-blur-md">
              {/* GitHub Link */}
              {project.github ? (
                <a
                  href={project.github}
