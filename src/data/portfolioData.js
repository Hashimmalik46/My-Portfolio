...
export const portfolioData = {
  ...
  projectsSection: {
    ...
    projects: [
      ...
      {
        id: "zooncare-uiux",
        title: "ZoonCare — Clinical OS Design System",
        img: "/gallery/Zooncare.webp",
        category: "UI/UX Design",
        status: "Figma System",
        short_desc:
          "High-precision dark-mode UI/UX design crafted in Figma, featuring modular clinical dashboards, tokenized component libraries, and patient booking flows.",
        highlights: [
          "Complete atomic design token taxonomy (colors, elevation, glassmorphism & typography)",
          "Interactive multi-role dashboard widgets with real-time responsive analytics layouts",
        ...
        tags: [
          ...
          { id: 4, tag: "Prototyping" },
        ],
        link: "https://zooncare.in",
        github: "https://github.com/Hashimmalik46",
      },
      {
        id: "campus-connect-uiux",
        title: "Campus Connect — Social Platform UI/UX",
        img: "/gallery/CC.webp",
        category: "UI/UX Design",
        status: "Figma Prototype",
        short_desc:
          "Mobile-first student community UI/UX created in Figma, focusing on fluid feed interactions, campus event discovery, and peer connectivity.",
        highlights: [
          "Engaging card-based social feed and event curation layout architecture",
          "Intuitive navigation ergonomics designed for rapid student peer discovery",
          "Comprehensive Figma component library with variants, interactive states, and autolayouts",
        ],
        tags: [
          { id: 1, tag: "Figma" },
          { id: 2, tag: "Mobile UX" },
          { id: 3, tag: "Social UI" },
          { id: 4, tag: "Interactive Prototypes" },
        ],
